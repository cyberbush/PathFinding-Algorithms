...
def printList(L):
    for i in L:
        ...
        #print(i.costtoreach+i.estimatedcosttogoal, end = " ") # A*
        print(i.estimatedcosttogoal, end = " ") # greedy
    print()
...
def search():
    ...
    start.parent = None
    start.estimatedcosttogoal = start.distance() * avg() # heuristic
    ...
    while(len(openlist) > 0):
        ...
        if(current.y > 0): #top neighbor
            ...
            if(not searchList(openlist, neighbor) and not searchList(closedlist, neighbor)):
                ...
                neighbor.estimatedcosttogoal = neighbor.distance() * avg() 
